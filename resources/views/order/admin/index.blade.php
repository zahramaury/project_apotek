...
<div class="container mt-3">
            <form action="{{ route('order.search') }}" method="GET" >
                <div class="d-flex" style="width: 400px">
                 <input type="date" name="search" id="search" value="{{ request('searchDateAdmin') }}" class="form-control" style="height:40px; margin-right: 1rem;">
                        <button type="submit" class="btn btn-primary" style="width: 200px;height:40px; margin-right: 1rem;">Cari Data</button>
                        <a href="{{ route('order.index') }}" class="btn btn-secondary" style="height:40px;">Reset</a>
                </div>
            </form>
          </div>
